...
Leia os três primeiros na ordem. Depois siga a trilha do que você vai fazer.
...
| 3 | [Engenharia de software](05-engenharia-de-software.md) — git, ambientes, testes, revisão | todos |
| 4a | [A plataforma Flask](03-a-plataforma-flask.md) | quem mexe em `platform/` |
| 4b | [O firmware](04-o-firmware.md) | quem mexe em `firmware/` |
| 5 | [Primeira contribuição](06-primeira-contribuicao.md) — do clone ao pull request | todos |
